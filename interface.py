...
"border-top-right-radius:15px;")
        ...
        self.logo_lable = QtWidgets.QLabel(self.frame_5)
        self.logo_lable.setGeometry(QtCore.QRect(30, 20, 350, 40))
        self.logo_lable.setStyleSheet("background-color: rgb(69, 90, 179);")
...
"border-top-right-radius:15px;")
        ...
        self.data_get_btn.raise_()
        self.data_analysis_btn.raise_()
        self.choice_btn.raise_()
...
"color:#fff;")
        ...
        self.model_edit.setGeometry(QtCore.QRect(1010, 70, 140, 30))
        self.model_edit.setObjectName("model_edit")
        self.password_edit = QtWidgets.QLineEdit(self.frame)
        self.password_edit.setGeometry(QtCore.QRect(780, 70, 140, 30))
        self.password_edit.setObjectName("password_edit")
        self.username_edit = QtWidgets.QLineEdit(self.frame)
        self.username_edit.setGeometry(QtCore.QRect(570, 70, 140, 30))
...
"background-color: rgb(226,226,226);")
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 70, 72, 30))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
...
"border:0px solid black;")
        ...
        self.url_edit = QtWidgets.QLineEdit(self.frame)
        self.url_edit.setGeometry(QtCore.QRect(110, 70, 370, 30))
        ...
        self.label_7.setGeometry(QtCore.QRect(720, 70, 51, 30))
        self.label_7.setStyleSheet("border:0px;font: 10pt \"Microsoft YaHei UI\";")
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName("label_7")
        self.label_5 = QtWidgets.QLabel(self.frame)
        self.label_5.setGeometry(QtCore.QRect(940, 70, 61, 30))
        ...
        self.label_4.setGeometry(QtCore.QRect(490, 70, 72, 30))
...
"font: 10pt \"Microsoft YaHei UI\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "获取地址:"))
